...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '.vercel.app', '*.vercel.app', 'vercel.app']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'agenda.context_processors.cloud_settings',
            ],
        },
    },
]
...
# Forçar desativar SQLite Cloud em ambiente local a menos que especificamente habilitado
if not IS_VERCEL:
    SQLITECLOUD_ENABLED = os.environ.get('FORCE_SQLITECLOUD', 'False') == 'True'
else:
    # No Vercel, sempre usar SQLite Cloud
    SQLITECLOUD_ENABLED = True

# Debug da configuração do SQLite Cloud
print(f"SQLiteCloud Enabled: {SQLITECLOUD_ENABLED}, IS_VERCEL: {IS_VERCEL}")
...
# URL path para arquivos estáticos
STATIC_URL = '/static/'

# Diretórios onde o collectstatic procura arquivos
STATICFILES_DIRS = [
...
# URL para arquivos de mídia
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Configurações específicas para ambiente Vercel
if IS_VERCEL:
